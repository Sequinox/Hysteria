...
module.exports = {
  ...
  run (msg, args, client) {
    const embed = new modules.Discord.RichEmbed()
      .setColor('#3dfc89')
      .setAuthor('Hysteria : v0.2.4 - Click to contribute!', 'https://cdn.discordapp.com/avatars/667222783549374474/9acafc12428c1cf4c94cad5df1328915.png?size=2048', 'https://github.com/Sequinox/Hysteria')
